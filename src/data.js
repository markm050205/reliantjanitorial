...
// ---------------------------------------------------------------
export const BIZ = {
  name: 'Reliant Janitorial',
  phone: '', // paste number here when ready, e.g. '(856) 555-0123'
  phoneHref: '', // e.g. 'tel:+18565550123'
  email: 'quotes@reliantjanitorial.com', // REPLACE if different
  url: 'https://reliantjanitorial.com',
...
export const TOWNS = [
  'Cherry Hill', 'Voorhees', 'Haddonfield', 'Marlton', 'Mount Laurel',
  'Moorestown', 'Collingswood', 'Pennsauken', 'Gloucester Township',
  'Washington Township', 'Deptford', 'Haddon Heights', 'Audubon',
  'Somerdale', 'Stratford', 'Berlin',
];

export const LAST_UPDATED = 'August 2026';
export const GA4_ID = ''; // paste your G-XXXXXXXXXX here to enable analytics
export const SOCIAL_PROFILES = []; // add Facebook/GBP/Yelp URLs once live

export const SERVICE_TYPES = {
  'dental-medical-office-cleaning': 'Medical and dental office cleaning',
  'daycare-cleaning': 'Daycare and childcare center cleaning',
  'gym-fitness-cleaning': 'Gym and fitness studio cleaning',
  'bank-cleaning': 'Bank and credit union cleaning',
  'law-office-cleaning': 'Law office and professional office cleaning',
  'church-cleaning': 'Church and worship facility cleaning',
};
...
// ---------------------------------------------------------------
// Route level SEO metadata, used by the prerenderer and the client
// ---------------------------------------------------------------
export const ROUTES = [
  {
    path: '/',
